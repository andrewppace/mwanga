  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved relationship as @relationship" do
        ...
        post :create, {:relationship => { "invitor_id" => "invalid value" }}, valid_session
        assigns(:relationship).should be_a_new(Relationship)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested relationship" do
        ...
        Relationship.any_instance.should_receive(:update_attributes).with({ "invitor_id" => "1" })
        put :update, {:id => relationship.to_param, :relationship => { "invitor_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the relationship as @relationship" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Relationship.any_instance.stub(:save).and_return(false)
        put :update, {:id => relationship.to_param, :relationship => { "invitor_id" => "invalid value" }}, valid_session
        assigns(:relationship).should eq(relationship)
      end
